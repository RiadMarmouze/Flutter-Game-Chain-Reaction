...
import 'package:chain_reaction/services/auth_service.dart';
import 'package:chain_reaction/services/database_service.dart';
    ...
    if (formKey.currentState!.validate()) {
      ...
      await authService.loginWithUserNameandPassword(email, password).then((value) async {
        if (value == true) {
          ...
          Navigator.of(_scaffoldKey.currentContext!).pushNamed('/startgame');
        } else {
